          ...
          {({ open, close }) => (
            <>
              <Popover.Button
                ...
                className="px-2 py-1 sm:px-4 sm:py-2 rounded-full text-black font-semibold text-xl sm:text-2xl transition ease-out duration-200"
              >
                Меню
              </Popover.Button>
                    ...
                    {Object.entries(SideMenuItems).map(([name, href]) => (
                      <li key={name}>
                        <LocalizedClientLink
                          ...
                          className="text-xl sm:text-2xl font-bold text-choco hover:text-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-choco transition ease-out duration-200"
                        >
                          {name}
                        </LocalizedClientLink>
                      </li>
