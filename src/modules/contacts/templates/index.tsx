        ...
        <div className="space-y-6 text-left">
          <div className="bg-cream p-6 rounded-2xl shadow-sm border">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-choco">Телефон:</h3>
                <p className="text-choco/80">+7 (930) 817-00-07</p>
              </div>

              <div>
                <h3 className="font-medium text-choco">Email:</h3>
                <p className="text-choco/80">info@munches.com</p>
              </div>

              <div>
                <h3 className="font-medium text-choco">Адрес:</h3>
                <p className="text-choco/80">г. Сочи, ул. Перелетная, д. 32А</p>
              </div>

              <div>
                <h3 className="font-medium text-choco">Время работы:</h3>
                <p className="text-choco/80">
                  Пн-Пт: 9:00 - 18:00
                  <br />
                  Сб-Вс: 10:00 - 16:00
                </p>
          ...
          <div className="bg-cream p-6 rounded-2xl shadow-sm border">
            ...
            <p className="text-choco/80 mb-4">
