...
const DeliveryZoneMap: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Загружаем зону доставки из GeoJSON
    const geojsonObject = {
    ...
    const vectorLayer = new VectorLayer({
      ...
      style: new Style({
        ...
        stroke: new Stroke({ color: "#ff6600", width: 4, lineDash: [10, 10] }),
      }),
    })
    ...
    const map = new Map({
      ...
      view: new View({
        center: fromLonLat([39.95472429593818, 43.406133272085754]) as [
          number,
          number
        ],
        zoom: 12,
